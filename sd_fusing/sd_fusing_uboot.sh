...
bl1_position=1
uboot_position=49
kernel_position=1073
ramdisk_position=9265
...
#<kernel fusing>
#echo "kernel fusing"
#dd iflag=dsync oflag=dsync if=/home/he/work/QT210/android-kernel-samsung-dev-full/arch/arm/boot/uImage of=$1 seek=$kernel_position

####################################
#<kernel fusing>
#echo "kernel fusing"
#dd iflag=dsync oflag=dsync if=/home/he/work/QT210/android-samsung-dev-full-rtl81XX/out/target/product/smdkv210/ramdisk-uboot.img of=$1 seek=$ramdisk_position

...
#define CONFIG_NR_DRAM_BANKS	3	   /* we have 3 bank of DRAM (80MB OneDRAM + 256MB mDDR + 128MB mDDR) */

#define PHYS_SDRAM_1		MEMORY_BASE_ADDRESS /* SDRAM Bank #1 */
#define PHYS_SDRAM_1_SIZE       0x5000000 /*  256MB OneDRAM */
#define PHYS_SDRAM_2            (PHYS_SDRAM_1 + 0x10000000) /*  SDRAM Bank #2 */
#define PHYS_SDRAM_2_SIZE       0x10000000 /*  256MB mDDR */
#define PHYS_SDRAM_3            (PHYS_SDRAM_2 + 0x10000000) /*  SDRAM Bank #3 */
#define PHYS_SDRAM_3_SIZE       0x08000000 /*  128MB mDDR */

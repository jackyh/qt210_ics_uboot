...
/*
 * Date & Time support for the built-in Samsung S5P64XX RTC
 */

#include <common.h>
#include <command.h>

#if defined(CONFIG_RTC_S5P64XX) && defined(CONFIG_CMD_DATE)
...
{
	S5P64XX_RTC * const rtc = S5P64XX_GetBase_RTC();
	switch (a) {
		case RTC_ENABLE:
...
#endif	/* CONFIG_RTC_S5P64XX && CFG_CMD_DATE */
